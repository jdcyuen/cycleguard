...
from engine.recovery_manager import RecoveryManager, IRecoveryStateStore
...
class TestRecoveryManager(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_config = {
            ...
            "system": {"files": {"recovery": "test_recovery.json"}},
        }
    ...
    def test_update_bottom(self):
        ...
        portfolio = {"SMH": 1000}
        market = {"close": 100.0, "drawdown": -0.1}  # -10% from unknown peak
    ...
    def test_recovery_trigger(self):
        ...
        market = {"close": 97.0, "drawdown": -0.03}  # Rebound hit!
    ...
    def test_reset_at_peak(self):
        ...
        portfolio = {"SMH": 1000}
        market = {"close": 120.0, "drawdown": 0.0}  # BACK TO PEAK
